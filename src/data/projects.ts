...
export const projects: Project[] = [
  ...
  },
  {
    id: "vitrine-blue",
    title: "Casio Luxe",
    subtitle: "Maquette Horlogerie d'Excellence",
    description: "Une vitrine de prestige pour la marque Casio Luxe, alliant innovation technologique japonaise et élégance intemporelle.",
    fullDescription: "Casio Luxe est un projet de site vitrine haut de gamme mettant en scène une fusion parfaite entre tradition horlogère et modernité technologique. Le design sombre, ponctué d'accents dorés, souligne l'exclusivité et la précision des garde-temps.",
    tags: ["React", "Luxe", "Design Épuré"],
    images: ["/src/assets/Capture3.PNG"],
    year: "2026",
    link: "https://vitrine-blue.vercel.app/",
  },
  {
    id: "e-poubelle",
    title: "E-Poubelle",
